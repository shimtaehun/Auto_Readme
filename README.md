# Auto_Readme — 코드 분석 기반 README 자동 생성기

GitHub 저장소나 업로드한 프로젝트의 소스코드를 읽어서 README.md를 자동으로 작성해주는 웹 애플리케이션입니다. README를 매번 직접 쓰는 게 번거롭다는 데서 시작했고, 단순 요약이 아니라 코드를 실제로 분석해서 문서를 만드는 것을 목표로 했습니다. 분석한 코드에 대해 자유롭게 질문할 수 있는 Q&A 챗봇도 함께 붙였습니다.
...
<p align="center">
  <b>1인 개발</b> · Streamlit + Gemini + LangChain RAG
</p>
